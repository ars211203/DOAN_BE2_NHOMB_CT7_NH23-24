<section id="about">
    <div class="about container">
      ...
      <div class="col-right">
        ...
        <h2>Tác giả: <?php echo e($mostViewedBook->book_author); ?></h2>
        <h2>Lượt đọc: <?php echo e($mostViewedBook->book_type); ?></h2>
        <p><?php echo e($mostViewedBook->book_description); ?></p>
        <a href="<?php echo e(route('detail.book',$data->id)); ?>" class="cta">Đọc ngay</a>
      </div>
    </div>
  </section><?php /**PATH G:\Xampp\htdocs\DoAnBe_2_Backup\DoAn_BE2_CT7\resources\views/topbook.blade.php ENDPATH**/ ?>