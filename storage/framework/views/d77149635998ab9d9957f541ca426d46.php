          ...
          <div class="card card-primary">
            ...
            <div class="card-body">            
              <div class="form-group">
                ...
                <input type="password" name="password" value="<?php echo e($user->password); ?>" class="form-control" placeholder="Nhập password">              
              </div>
            </div>
            <div class="card-body">            
              <div class="form-group">
                <Strong>Loại tài khoản(chọn 0 or 1)</Strong>
                <input type="text" name="user_type" value="<?php echo e($user->user_type); ?>" class="form-control" placeholder="Chọn 0 hoặc 1">              
              </div>
            </div>
            <div class="card-body">            
              <div class="form-group">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Xampp\htdocs\DoAn_BE2_CT7\resources\views/users/edit.blade.php ENDPATH**/ ?>