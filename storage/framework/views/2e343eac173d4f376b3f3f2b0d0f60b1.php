      ...
      <div class="nav-bar" style="background-color: #555;">
        ...
        <div class="nav-list">
          ...
          <ul>
            ...
            <li><a href="<?php echo e(route('history.read')); ?>" data-after="Projects">Lịch sử đọc</a></li>
    ...
    <div class="services container">
      ...
      <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="icon"><img src="<?php echo e(asset("image_data/{$data->book_image}")); ?>" alt="Book cover"></div>
            <h2><a href="chitiet.html" id="action_book"><?php echo e($data->book_name); ?> </a></h2>
            <p><?php echo e($data->book_description); ?>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
          </div>
...
</body><?php /**PATH G:\Xampp\htdocs\DoAn_BE2_CT7\resources\views/books/search.blade.php ENDPATH**/ ?>