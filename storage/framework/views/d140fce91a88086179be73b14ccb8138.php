            ...
            <table class="table table-bodered">
                ...
                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><?php echo e($data->id); ?></td>
                        ...
                        <td>
                        <a class="btn btn-info" href="<?php echo e(route('book.sections.edit', $data->id)); ?>">Sửa Tập</a>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Xampp\htdocs\DoAn_BE2_CT7\resources\views/sections/index.blade.php ENDPATH**/ ?>